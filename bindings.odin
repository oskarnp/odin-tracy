...
when ODIN_OS == .Darwin  do foreign import tracy "libtracy:tracy.dylib"
when ODIN_OS == .Windows do foreign import tracy "libtracy:tracy.lib"
when ODIN_OS == .Linux   do foreign import tracy "libtracy:tracy.so"
